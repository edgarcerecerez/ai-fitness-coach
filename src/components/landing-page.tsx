...
/**
 * Public marketing landing page for the AI Fitness Coach app. Shown to
 * unauthenticated visitors at `/`. Authenticated users are redirected to
 * `/dashboard` by `src/app/page.tsx` before this component is rendered.
 */
